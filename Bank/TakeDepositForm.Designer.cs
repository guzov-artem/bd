...
namespace Bank
{
  partial class TakeDepositForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.label2.Text = "Сумма к снятию:";
      // 
      // label1
      // 
      ...
      this.Name = "TakeDepositForm";
      this.Text = "TakeDepositForm";
      this.Load += new System.EventHandler(this.TakeDepositForm_Load);
